...
include_once('db_config.php');
   ...
   if($con) 
      { 
	$sql_update = "UPDATE Previous_Record
				SET Start_date = to_date('$_POST[Start_date]','dd/mm/yyyy'),
				To_end_date = to_date('$_POST[To_end_date]','dd/mm/yyyy'),	
      ...
      $sql_insert="insert into Previous_Record(D_id,Start_date,To_end_date,Establishment,Position)
                            values ('$_POST[D_id]','to_date('$_POST[Start_date]','dd/mm/yyyy')','$_POST[C_id]','to_date('$_POST[To_end_date]','dd/mm/yyyy')','$_POST[Establishment]','$_POST[Position]')";
	  	         $sql_Delete = "DELETE FROM Previous_Record
					WHERE D_id = '$_POST[D_id]'";
      $Msg_Desc = "";
      if ($_REQUEST[flag] == 1){
...
?>	
<div class="main_box">
		<div class="myDIV" align="center"><h1><font color=#5499C7> Previous_Record </h1></div>
		<br>
						  <form  name="form2" method="POST" action="previous_record.php">
			<div class="subbox1"> 
		...
		<Table class ="table1" padding=10>
				  ...
				  <table align=center border="0" border-colour=black cellpadding="2" width="375"  >
					<tr>
						<td width="150" align="left">*Doctor ID</td>
						<td width="211"><input type="text" class="IN_box" name="D_id"  onfocus="" value=<?php echo $D_id?>></td>
					</tr>
					<tr>
						<td width="150" align="left">Start_date</td>
						<td width="211">
						<input name="Start_date" class="IN_box" value=<?php echo $Start_date ?> ></td>
					</tr>
					
					<tr>
						<td width="150" align="left">End Date</td>
						<td width="211">
						<input type="text" class="IN_box" name="To_end_date" value=<?php echo $To_end_date ?>></td>
					</tr>
					
					<tr>
						<td width="150" align="left">Establishment</td>
						<td width="211">
						<input type="text" class="IN_box" name="Establishment" value=<?php echo $Establishment ?>></td>
					</tr>
					...
					<tr>
						...
						<td width="211">
						<input type="text" class="IN_box" name="Position"  value=<?php echo $Position ?>></td>
					</tr>
