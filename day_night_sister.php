...
include_once('db_config.php');
  ...
  $db_sid = "(DESCRIPTION = (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = THE_RAIN)(PORT = 1521)) ) (CONNECT_DATA = (SID = ali) ) )"; 
   ...
   if($con) 
      { 
	$sql_update = "UPDATE Day_Night_sister
				SET DN_name = '$_POST[DN_name]',
				DN_address='$_POST[DN_address]',
				DN_salary='$_POST[DN_salary]',
				DN_type='$_POST[DN_type]',
				DN_phone='$_POST[DN_phone]'".
				"WHERE DN_id ='$_POST[DN_id]'";
				
      $sql_select = "SELECT *".
                  " FROM Day_Night_sister".
                  " WHERE DN_id='$_POST[DN_id]'";
				  
      $sql_insert="insert into Day_Night_sister(DN_id,DN_name,DN_phone,DN_type,DN_salary,DN_address)
                            values ('$_POST[DN_id]','$_POST[DN_name]','$_POST[DN_phone]','$_POST[DN_type]','$_POST[DN_salary]','$_POST[DN_address]')";
	         $sql_delete = "DELETE FROM Day_Night_sister
					WHERE DN_id = '$_POST[DN_id]'";
      $Msg_Desc = "";
      if ($_REQUEST[flag] == 1){
...
?>	
<div class="main_box">
		<div class="myDIV" align="center"><h1><font color=#5499C7> DAY NIGHT SISTER FORM </h1></div>
		<br>
						  <form  name="form2" method="POST" action="day_night_sister.php">
			<div class="subbox1"> 
		...
		<Table class ="table1" padding=10>
				  ...
				  <table align=center border="0" border-colour=black cellpadding="2" width="375"  >
					<tr>
						<td width="150" align="left">*DayNight_Sister_id</td>
						<td width="211"><input type="text" class="IN_box" name="DN_id"  onfocus="" value=<?php echo $DN_id?>></td>
					</tr>
					<tr>
						<td width="150" align="left">*DayNight_Sister_Name</td>
						<td width="211">
						<input name="DN_name" class="IN_box" value=<?php echo $DN_Name ?> ></td>
					</tr>
					<tr>
						<td width="150" align="left">Phone#</td>
						<td width="211">
						<input type="number" class="IN_box" name="DN_phone"  value=<?php echo $DN_phone ?>></td>
					</tr>
					<tr>
						<td width="150" align="left">Type</td>
						<td width="211">
						<input type="text" class="IN_box" name="DN_type"  value=<?php echo $DN_type ?>></td>
					</tr>
					<tr>
						<td width="150" align="left">Address</td>
						<td width="211">
						<input type="text" class="IN_box" name="DN_address"  value=<?php echo $DN_address ?>></td>
					</tr>
					<tr>
						<td width="150" align="left">Salary</td>
						<td width="211">
						<input type="text" class="IN_box" name="DN_salary" value=<?php echo $DN_salary ?>></td>
					</tr>
