  ...
  $db_sid = "(DESCRIPTION = (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = THE_RAIN)(PORT = 1521)) ) (CONNECT_DATA = (SID = ali) ) )"; 
   ...
   if($con) 
	...
	"UPDATE Care_Unit
      ...
      $sql_select="SELECT *".
                  " from Care_Unit".
                  " where Ca_id ='$_POST[Ca_id]'";

      $sql_insert="insert into Care_Unit(Ca_id,C_name,W_id,S_id)
                            values ('$_POST[Ca_id]','$_POST[C_name]','$_POST[W_id]','$_POST[S_id]')";
      $sql_Delete = "DELETE FROM Care_Unit
					WHERE Ca_id = '$_POST[Ca_id]'";
		$Msg_Desc="";
      if ($_REQUEST[flag] == 1){
...
?>	
<div class="main_box">
		<div class="myDIV" align="center"><h1><font color=#5499C7> CARE UNIT FORM </h1></div>
		<br>
						  <form  name="form1" method="POST" action="care_unit.php">
			<div class="subbox1"> 
		...
		<Table class ="table1" padding=10>
				  ...
				  <table align=center border="0" border-colour=black cellpadding="2" width="375"  >
					<tr>
						<td width="150" align="left">*Care_Unit_ID</td>
						<td width="211"><input type="text" class="IN_box" name="Ca_id"  onfocus="" value=<?php echo $Ca_id?>></td>
					</tr>
					<tr>
						<td width="150" align="left">Care_Unit_Name</td>
						<td width="211">
					...
					<tr>
						...
						<td width="211">
						<input type="text" class="IN_box" name="S_id"  value=<?php echo $S_id ?>></td>
					</tr>
				</table>
		</Table>
